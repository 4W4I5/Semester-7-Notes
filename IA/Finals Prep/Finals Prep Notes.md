...
> [!NOTE]
> I_PL, I_rPL, I_Dt, I_Rt, I_CtS, I_Rv, Dmg, A_Rp
...
| **Incident Reaction**               | - **Incident reaction** consists of actions that guide the organization to stop the incident, mitigate its impact, and provide information for recovery.<br>- **Actions that must occur quickly:** <br>- Notification of key personnel <br>- Documentation of the incident                                                                                                                                                                                                |
...
> [!NOTE]
> GI, ISMA, ISG, SDLC, A&T, CP&IC, IcS, PM, SecPL, ITCPl, RMgmt, CA&SA, SS&PA, IR, CMgmt
...
> [!NOTE]
> PT, I<sup>2</sup>/W/MVA, PSV, D/RVuln, AoTR, Tr, VulnR, RR
...
| **Readiness & Review**                 | - Keep the information security program functioning as designed and continuously improving.<br>- Accomplished by:<br>- Policy Review<br>- Program Review<br>- Rehearsals                                              |
