...
| **3. Backdoors**                                                  | Attackers exploit backdoors in software to gain unauthorized access.                                                     |
| **4. Password Cracking**                                          | Methods such as **brute force** and **dictionary attacks** are used to guess passwords.                                  |
| **5. Denial-of-Service (DoS)**                                    | Overwhelming systems with excessive requests, leading to crashes or loss of service.                                     |
| **6. Spoofing**                                                   | Impersonating trusted sources to bypass security controls.                                                               |
| **7. Man-in-the-Middle**                                          | Intercepting and altering communication between two parties.                                                             |
| **8. Sniffers**                                                   | Capturing network traffic for either legitimate monitoring or malicious purposes.                                        |
| **9. Phishing & Pharming**                                        | Deceptive tactics to steal sensitive information through fake websites or emails.                                        |
| **10. Social Engineering**                                        | Manipulating individuals to reveal confidential data.                                                                    |
| **11. Buffer Overruns**                                           | A program writes more data to a buffer than it can handle, leading to system crashes or unauthorized code execution.     |
| **12. Command Injection**                                         | Attackers inject commands into a system’s input to execute unauthorized actions.                                         |
| **13. Cross-Site Scripting (XSS)**                                | Injecting malicious scripts into websites to exploit users.                                                              |
